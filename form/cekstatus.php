...
<head>
  ...
  <title>Cek Status Pendaftran</title>
   <style>
    img{
 ...
 <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="img-fluid w-100 overflow-hidden"
                    src="../assets/img/index5.jpeg"
                    class="w-100" alt="...">
                <div class="carousel-caption d-block">
                  <!-- Masthead Heading-->
                <form action="cekstatus-proses.php" method="POST">
                          ...
                          <div class="search">
                            <div class="search-box">
                              <div class="search-field">
                                 <input placeholder="Search..." class="input" type="text" name="kode">
                                  <div class="search-box-icon">
                                    <button class="btn-icon-content" name="kirim">
                                       <i class="search-icon">
